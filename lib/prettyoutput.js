...
internals.parseOptions = (opts) => {
    ...
    const indentation = opts.indentationLength
        ? utils.indent(opts.indentationLength)
        : utils.indent(2)
    ...
    return {
        ...
        alignKeyValues: typeof opts.alignKeyValues === 'boolean' ? opts.alignKeyValues : true,
        hideUndefined: typeof opts.hideUndefined === 'boolean' ? opts.hideUndefined : false,
    }
}
